...
This is a personal portfolio website built using Vite + React, Tailwind CSS, and Framer Motion to showcase skills, projects, certifications, and experience.
...
2. Navigate to the project directory:
   ```sh
   cd illustration-portfolio-main
   ```
