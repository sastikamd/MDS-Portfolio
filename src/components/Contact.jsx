    ...
    >
      ...
      <div className='flex justify-between items-center mt-8 lg:mt-16 flex-col lg:flex-row'>
            ...
            >
              ...
              <div className='flex items-center gap-x-2 lg:gap-x-5'>
                {[
                  ...
                  { Icon: IoLogoLinkedin, href: "https://www.linkedin.com/in/sastika-m-d-004861178" },
                  { Icon: BsGithub, href: "https://github.com/sastikamd" },
                ].map(({ Icon, href }, index) => (
                  <motion.a
                    key={index}
                    href={href}
        ...
        >
          ...
          <p className='text-[#71717A] text-sm/6 lg:text-base mt-3 lg:mt-6'>Building scalable web applications with modern technologies, clean code, and best practices. Open to opportunities.</p>

          <div className='font-semibold text-sm lg:text-xl flex flex-col mt-6 gap-2 lg:gap-4'>
            <motion.a
              whileHover={{ x: 5 }}
              className='flex items-center gap-2 group'
              href="mailto:sastimeena@gmail.com"
            >
              <span className='border-2 transition-all border-transparent group-hover:border-black rounded-full p-1'>
                <IoMdMail className="w-4 h-4 lg:w-5 lg:h-5" />
              </span>
              sastimeena@gmail.com
            </motion.a>

            <motion.a
              whileHover={{ x: 5 }}
              className='flex items-center gap-2 group'
              href="tel:+919566328708"
            >
